...
let tinput1 = [|1;2;1;2|]
let tinput2 = [|1;2;2;1|]
let tinput3 = [|1;2;3;4;2;5|]
let tinput4 = [|1;2;3;1;2;3|]
let tinput5 = [|1;2;1;3;1;4;1;5|]
...
let sum (input: int list) : int =
    ...
    let step (i: int) (v: int) : unit =
        let v' = 
            ...
            then 
                let idx = (i + sc) - input.Length
                if idx < 0 then printfn "input=%A, i=%d, sc=%d, idx=%d" input i sc idx
                input.[idx] 
            else 
                input.[i + sc]
...
printfn "Solution for %A = %d" tinput5 (sum (List.ofArray tinput5))
